...
import TopriseCategory from '@/components/icons/toprise-category'
...
export const pricingCards = [
  {
    title: 'Starter',
    description: 'Perfect for trying out toprise',
    price: 'Free',
    duration: '',
    highlight: 'Key features',
    features: ['3 Sub accounts', '2 Team members', '∞ pipelines'],
    priceId: '',
  },
  {
    title: 'Growth',
    ...
    duration: 'month',
    highlight: 'Key features',
    features: ['Everything in Basic', 'Free marketing', '24/7 Support team'],
  ...
  },
  {
    ...
    features: ['Everything in Starter', '∞ Sub accounts', '∞ Team members'],
